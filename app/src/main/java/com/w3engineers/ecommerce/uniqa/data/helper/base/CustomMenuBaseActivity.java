...
import com.w3engineers.ecommerce.uniqa.ui.search.SearchActivity;

public abstract class CustomMenuBaseActivity<V extends MvpView, P extends BasePresenter<V>>
    ...
    public void updateMenu() {
        if (tvCartCount != null) {
            AsyncTask.execute(() -> {
                if (DatabaseUtil.on().getAllCodes().size() >= 0)
                    size = DatabaseUtil.on().getItemCount();
                runOnUiThread(() -> tvCartCount.setText("" + size));
            });
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        item.getActionView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CustomMenuBaseActivity.this, CartActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
                Intent intent = new Intent(CustomMenuBaseActivity.this, SearchActivity.class);
                startActivity(intent);
                return true;
            default:
